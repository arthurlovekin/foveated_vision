...
class PeripheralFovealVisionModelLoss:
    def __init__(self, default_fovea_shape=(0.25, 0.25)):
        ...
        self.mse_fovea_weight = 1.0  # On bounding box of next fixation vs the true next bounding box
        self.mse_weight = 1.0  # On predicted bounding box
        self.iou_weight = 0.1  # WARNING: setting this to 1 is breaking things
